...
public class MainController {
	...
	public ModelAndView getReservation(
		...
		mav.addObject("user", user);
		mav.addObject("apartments", apartmentService.findAll());
	...
	*/
	...
	public ModelAndView getReservedDates(@RequestParam(required = false) Integer month
		...
		Iterable<Reservation> reservationServiceAll = reservationService.findAll();
		for(Reservation reservation : reservationServiceAll) {
			Apartment apartment;
	...
	private RedirectView saveNewReservation(
		...
		Apartment apartment = apartmentService.findById(new Integer(apartmentId)).get();
	...
	/**
	 * Gets user name if user is authenticated
	 * @return user name if user is authenticated,
	 * otherwise returns String with value of "anonymousUser"
	 */
	...
	/**
	 * Gets all dates between two given dates, start date included, end date excluded 
	 * @param startDate start date of period included
	 * @param endDate end date of period excluded
	 * @return List consisting of dates between two given dates
	 * @throws IllegalArgumentException if given endDate is before starDate
	 */
